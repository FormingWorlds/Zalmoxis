...
| `paleos_iron_eos_table_pt.dat` | `data/EOS_PALEOS_iron/` | Space-separated, 10 columns (P, T, rho, u, s, cp, cv, alpha, nabla_ad, phase) | [Attia et al. (2026)](https://ui.adsabs.harvard.edu/abs/2026arXiv260503741A/abstract); PALEOS (Zenodo 22776069, v1.3.0) | Unified Fe EOS, 5 stable phases (alpha-bcc, delta-bcc, gamma-fcc, epsilon-hcp, liquid). P: 1 bar--100 TPa, T: 300--100000 K. 75.3 MB. |
| `paleos_mgsio3_eos_table_pt.dat` | `data/EOS_PALEOS_MgSiO3_unified/` | Space-separated, 10 columns (same as iron) | [Attia et al. (2026)](https://ui.adsabs.harvard.edu/abs/2026arXiv260503741A/abstract); PALEOS (Zenodo 22776069, v1.3.0) | Unified MgSiO3 EOS, 6 stable phases (3 pyroxene, bridgmanite, postperovskite, liquid). P: 1 bar--100 TPa, T: 300--100000 K. 48.6 MB. |
| `paleos_water_eos_table_pt.dat` | `data/EOS_PALEOS_H2O/` | Space-separated, 10 columns (same as iron) | [Attia et al. (2026)](https://ui.adsabs.harvard.edu/abs/2026arXiv260503741A/abstract); PALEOS (Zenodo 22776069, v1.3.0) | Unified H2O EOS, 7 EOS (ice Ih--X, liquid, vapor, superionic). P: 1 bar--100 TPa, T: 100--100000 K. 192.7 MB. |
