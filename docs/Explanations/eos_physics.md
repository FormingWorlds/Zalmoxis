...
The PALEOS tables (`PALEOS:iron`, `PALEOS:MgSiO3`, `PALEOS:H2O`) are the standard EOS in Zalmoxis. PALEOS is developed and maintained at [github.com/maraattia/PALEOS](https://github.com/maraattia/PALEOS); the tables used by Zalmoxis are distributed via [Zenodo record 19000316](https://zenodo.org/records/19000316).
