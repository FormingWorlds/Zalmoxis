...
* `SeagerEarth`: Simulates Earth-like rocky planets with masses of 1, 5, 10, and 50 Earth masses, to replicate the models in Seager et al. (2007). Use this with the Earth-like rocky planet configuration.
