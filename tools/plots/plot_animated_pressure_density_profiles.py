...
def create_video(pressure_filename, density_filename):
    ...
    def make_pressure_movie(r_all, p_all):
        ...
        ani.save(
            os.path.join(get_zalmoxis_root(), 'output', 'pressure_evolution.mp4'),
            writer='ffmpeg',
            fps=2,
        )
        # plt.show()
    ...
    def make_density_movie(r_all, d_all):
        ...
        ani.save(
            os.path.join(get_zalmoxis_root(), 'output', 'density_evolution.mp4'),
            writer='ffmpeg',
            fps=2,
        )
        # plt.show()
...
if __name__ == '__main__':
    pressure_filename = os.path.join(get_zalmoxis_root(), 'output', 'pressure_profiles.txt')
    density_filename = os.path.join(get_zalmoxis_root(), 'output', 'density_profiles.txt')
